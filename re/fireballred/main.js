...
const reComponent = () => ({
  init() {
    ...
    const buttonList = [colorE, colorI, colorEI2, colorEI3 , colorE2 , colorE3 ,  dnaE, dnaI, wheelE, wheelI, brakeE, brakeI, accessE, accessI, engineE, engineI, displayE, displayI, headlampE, headlampI]
    ...
    const subColor3click = () => {
        ...
        remodel.removeAttribute('gltf-model')
        remodel.setAttribute('gltf-model', '#reyellow')
      }
